    ...
    <div ref={rootRef} className="relative inline-block text-left">
      ...
      {open && (
        <div
          ...
          className="absolute right-0 z-50 mt-1 min-w-[14rem] overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-lg shadow-slate-900/10"
        >
          <button
            type="button"
            role="menuitem"
          ...
          >
            ...
            <span className="text-xs text-slate-500">Group course activities and items</span>
          </button>
        </div>
      )}
    </div>
