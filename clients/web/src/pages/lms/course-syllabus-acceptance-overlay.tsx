...
import { SyllabusMarkdownView } from '../../components/syllabus/syllabus-markdown-view'
import { resolveMarkdownTheme, type MarkdownThemeCustom } from '../../lib/markdown-theme'
...
export function CourseSyllabusAcceptanceOverlay({ courseCode }: { courseCode: string }) {
  ...
  if (syllabusGate === 'ok' || syllabusGate === 'checking') {
    return null
  }
