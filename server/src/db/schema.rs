...
pub const SAML_IDP_CONFIGURATIONS: &str = "settings.saml_idp_configurations";
pub const SAML_AUTHN_REQUEST_STATE: &str = "settings.saml_authn_request_state";
pub const SAML_REPLAY_GUARD: &str = "settings.saml_replay_guard";
pub const USER_OIDC_IDENTITIES: &str = "settings.user_oidc_identities";
pub const OIDC_PROVIDER_CONFIGURATIONS: &str = "settings.oidc_provider_configurations";
pub const OIDC_FLOW_STATE: &str = "settings.oidc_flow_state";
pub const OIDC_LINK_INTENTS: &str = "settings.oidc_link_intents";
